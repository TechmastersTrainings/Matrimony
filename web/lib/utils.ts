/**
 * Helper to generate branded Shalom SVG avatar placeholder with member ID (e.g. SH-1).
 */
export function getDefaultAvatarSvg(label: string = 'SH-1'): string {
...
/**
 * Fallback branded Shalom SVG avatar placeholder with SH-1.
 */
export const DEFAULT_AVATAR_SVG = getDefaultAvatarSvg('SH-1');
