    ...
    <section className="py-8 sm:py-10 bg-gradient-to-b from-[#fdfbf7] via-[#faf6ee] to-[#fdfbf7] text-[#1e1b18] border-t border-charcoal-100/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-5 sm:mb-6 space-y-1.5">
          ...
          <div className="pt-1">
            <blockquote className="text-xs sm:text-sm font-serif italic text-charcoal-800 max-w-xl mx-auto leading-relaxed bg-white/90 border border-orange-200 py-2.5 px-4 rounded-xl shadow-2xs">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-700 bg-white/95 border border-slate-200 px-2 py-0.5 rounded-md">
                    {p.badge}
                  </span>
                </div>
