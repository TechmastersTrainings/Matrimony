    ...
    <section id="about" className="py-8 sm:py-10 bg-[#fdfbf7] text-[#1e1b18] border-t border-charcoal-100/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5 sm:gap-5 items-stretch">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-white border border-charcoal-200/80 flex flex-col justify-between space-y-3.5 shadow-2xs hover:border-cyan-300 transition-all">
            ...
            <div className="pt-2.5 border-t border-charcoal-100 grid grid-cols-2 gap-2.5 text-left">
              <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-xl p-2.5">
                ...
                <span className="text-[11px] text-emerald-800 font-medium">Zero public search leakage</span>
              </div>
              <div className="bg-orange-50/70 border border-orange-200/80 rounded-xl p-2.5">
                ...
                <span className="text-[11px] text-orange-800 font-medium">Pastoral &amp; parental honor</span>
              </div>
            </div>
          </div>

          {/* Column 2: Techmasters Innovations Private Limited */}
          <div className="p-5 sm:p-6 rounded-2xl bg-white border border-charcoal-200/80 flex flex-col justify-between space-y-3.5 shadow-2xs hover:border-orange-300 transition-all">
            <div className="space-y-2.5">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-orange-50 border border-orange-200 text-[11px] font-bold text-orange-950">
            ...
            <div className="p-3 rounded-xl bg-orange-50/40 border border-orange-200/60 space-y-1.5 text-xs">
              ...
              <div className="pt-1.5 border-t border-orange-200/40 flex flex-wrap items-center justify-between gap-1 text-[11px] text-slate-600">
                <a
