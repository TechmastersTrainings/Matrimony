...
class AuditAction(str, enum.Enum):
    ...
    CHAT_RESTRICT = "CHAT_RESTRICT"


class ModerationCategory(str, enum.Enum):
    PHONE_NUMBER = "PHONE_NUMBER"
    PHONE_NUMBER_OBFUSCATED = "PHONE_NUMBER_OBFUSCATED"
    NUMBER_WORD_SEQUENCE = "NUMBER_WORD_SEQUENCE"
    EMAIL = "EMAIL"
    ...
    CONTACT_SHARING_INTENT = "CONTACT_SHARING_INTENT"
    EXTERNAL_PLATFORM_MIGRATION = "EXTERNAL_PLATFORM_MIGRATION"
    SPAM = "SPAM"
