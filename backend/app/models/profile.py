...
class Profile(Base):
    ...
    marital_status = Column(SQLEnum(MaritalStatus), default=MaritalStatus.NEVER_MARRIED, nullable=True)
    ...
    denomination = Column(SQLEnum(Denomination), default=Denomination.METHODIST, nullable=True)
    ...
    district = Column(String(100), default="Bidar", nullable=True)
    ...
    occupation_type = Column(SQLEnum(OccupationType), default=OccupationType.PRIVATE, nullable=True)
    occupation_title = Column(String(100), nullable=True)
    employed_in = Column(String(150), nullable=True)
    annual_income_min = Column(Integer, nullable=True)
